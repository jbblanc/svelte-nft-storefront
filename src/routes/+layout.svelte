<script lang="ts">
  ...
  import {
    enrichConfigFromLocalStorage,
    getThemeIfAnyFromLocalStorage,
  } from '../libs/config-storage';
  ...
  export let data;
  let initialNetworks: Network[] = data.initialNetworks;
  $: console.log(data);
  initScanUrls();
...
<div
  class="min-h-screen main-layout"
  data-theme={$theme}
